...
function add_ask_product_settings()
{
  ...
  <div class="carousel-inner">
    ...
    <a href="http://quoteup.wisdmlabs.com" target="_blank">
      <img src="<?php echo plugins_url('/img/fromBuilder.png', __FILE__); ?>" width="100%" alt="Product Enquiry Pro">
    </a>
    </div>
  </div>
...
<label for="send-mail-to-product-author"> <?php _e("Send mail to Product Author ", "product-enquiry-for-woocommerce");?> </label>
    ...
    echo wdmHelpTip($helptip);
    ?>      
<input name="wdm_form_data[send_mail_to_author]" type="checkbox" class="wdm_wpi_input wdm_wpi_checkbox" value="1" <?php checked(1, isset($form_data[ 'send_mail_to_author' ]) ? $form_data[ 'send_mail_to_author' ] : 0);
...
function contact_email()
{
    ...
    // Set and wordwrap message body
        ...
        $premiumMail = "<br><hr>";
        $premiumMail .= "<p>" . sprintf(__('Checkout %s Product Enquiry Pro %s for these <b>PREMIUM</b> features', 'product-enquiry-for-woocommerce'), "<a href='https://wisdmlabs.com/woocommerce-product-enquiry-pro/?utm_source=in-product-ads&utm_medium=in-product-clicks&utm_content=admin-enquiry-email&utm_campaign=product-enqiry-free'>", "</a>") .": </p>";
        $premiumMail .= "<ul>
